...
namespace aga
{
    ...
    std::map<ScreenRelativePosition, std::string> g_ScreenRelativePosition
    ...
    bool AreSame (float a, float b, float epsilon) { return std::fabs (a - b) < epsilon; }

    //--------------------------------------------------------------------------------------------------

    bool AreSame (Point a, Point b, Point epsilonPoint)
    {
        return AreSame (a.X, b.X, epsilonPoint.X) && AreSame (a.Y, b.Y, epsilonPoint.Y);
    }
    ...
    {
        return {Lerp (a.X, b.X, percentage), Lerp (a.Y, b.Y, percentage)};
    }
