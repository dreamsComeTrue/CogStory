...
namespace aga
{
	...
	AudioManager::AudioManager (MainLoop* mainLoop)
		: m_MainLoop (mainLoop)
		, m_MasterVolume (1.0f)
		, m_SamplesEnabled (true)
		, m_StreamsEnabled (true)
		, m_IsPaused (false)
	{
	}
	...
	{
		SetSamplesEnabled (enabled);
		SetStreamsEnabled (enabled);
	}

	//--------------------------------------------------------------------------------------------------

	bool AudioManager::IsEnabled () { return m_SamplesEnabled || m_StreamsEnabled; }

	//--------------------------------------------------------------------------------------------------

	void AudioManager::SetSamplesEnabled (bool enabled) { m_SamplesEnabled = enabled; }

	//--------------------------------------------------------------------------------------------------

	bool AudioManager::IsSamplesEnabled () { return m_SamplesEnabled; }

	//--------------------------------------------------------------------------------------------------

	void AudioManager::SetStreamsEnabled (bool enabled)
	{
		if (enabled)
		{
		...
		m_StreamsEnabled = enabled;
	}

	//--------------------------------------------------------------------------------------------------

	bool AudioManager::IsStreamsEnabled () { return m_StreamsEnabled; }
