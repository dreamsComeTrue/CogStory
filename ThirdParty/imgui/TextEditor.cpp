...
const TextEditor::Palette & TextEditor::GetDarkPalette()
{
	const static Palette p = { {
		...
		0xff0E8E0E, // Comment (single line)
		0xff0E8E0E, // Comment (multi line)
		0xff493519, // Background
		0xffe0e0e0, // Cursor
		0xccf06020, // Selection
		0x800020ff, // ErrorMarker
		0x40f08000, // Breakpoint
		0xff707000, // Line number
		0xA062461f, // Current line fill
		0x40808080, // Current line fill (inactive)
		0x4000D8FF, // Current line edge
	} };
	return p;
}
