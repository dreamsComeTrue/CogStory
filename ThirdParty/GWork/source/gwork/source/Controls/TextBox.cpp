...
namespace Gwk
{
    ...
    {
    public:
        void Think () override { gwk_cast<TextBox> (m_control)->UpdateCaretColor (); }
    };
    ...
    void TextBox::OnPaste (Gwk::Controls::Base* /*ctrl*/) { InsertText (Platform::GetClipboardText ()); }
    ...
    void TextBox::OnMouseDoubleClickLeft (int /*x*/, int /*y*/) { OnSelectAll (this); }
    ...
    bool TextBox::HasSelection () { return m_cursorPos != m_cursorEnd; }
    ...
    int TextBoxMultiline::GetCurrentLine () { return m_text->GetLineFromChar (m_cursorPos); }
    ...
    void PasswordTextBox::SetPasswordChar (const char c) { m_passwordChar = c; }
