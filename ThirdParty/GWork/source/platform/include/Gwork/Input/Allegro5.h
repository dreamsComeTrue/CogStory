...
namespace Gwk
{
    namespace Input
    {
        ...
        public:
            ...
            void Initialize (IInputEventListener* el) { m_eventListener = el; }
            ...
            bool ProcessMessage (const ALLEGRO_EVENT& event)
            {
                ...
                switch (event.type)
                {
                    ...
                    case ALLEGRO_EVENT_MOUSE_BUTTON_UP:
                        return m_eventListener->InputMouseButton (event.mouse.button - 1, event.type == ALLEGRO_EVENT_MOUSE_BUTTON_DOWN);
                    ...
                    case ALLEGRO_EVENT_KEY_UP:
                    {
                        ...
                        if (event.keyboard.keycode != 0 && bPressed && event.keyboard.keycode >= ALLEGRO_KEY_A &&
                        ...
                        return key == Gwk::Key::Invalid ? false : m_eventListener->InputModifierKey (key, bPressed);
                    }
                }
