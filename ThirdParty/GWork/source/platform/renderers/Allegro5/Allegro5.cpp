...
namespace Gwk
{
    namespace Renderer
    {
        ...
        void Allegro::SetDrawColor (Gwk::Color color) { m_color = al_map_rgba (color.r, color.g, color.b, color.a); }
        ...
        void Allegro::RenderText (Gwk::Font* font, Gwk::Point pos, const Gwk::String& text)
        {
        ...
        void Allegro::DrawTexturedRect (Gwk::Texture* texture, Gwk::Rect rect, float u1, float v1, float u2, float v2)
        {
        ...
        Gwk::Color Allegro::PixelColor (Gwk::Texture* texture, unsigned int x, unsigned int y, const Gwk::Color& col_default)
        {
            ALLEGRO_BITMAP* bmp = (ALLEGRO_BITMAP*)texture->data;
        ...
        void Allegro::DrawLinedRect (Gwk::Rect rect)
        {
            ...
            const float fx = rect.x + 0.5f, fy = rect.y + 0.5f;
            al_draw_rectangle (fx, fy, fx + rect.w - 1, fy + rect.h - 1, m_color, 0.f);
        }
...
#undef ADD_LINE
        ...
        bool Allegro::EndContext (Gwk::WindowProvider* window) { return true; }
        ...
        ICacheToTexture* Allegro::GetCTT () { return m_ctt; }
